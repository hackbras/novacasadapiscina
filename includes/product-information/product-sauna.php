<div class="product__container">
    <aside class="product__menu">
        <div class="product__menu--tipo">
            <!--<h3>Tipos</h3>
            <ul>
                <li><a href="index.php?pagina=includes/product-information/product-sauna.php">Tipo 1</a></li>
                <li><a href="index.php?pagina=includes/product-information/product-sauna.php">Tipo 2</a></li>
                <li><a href="index.php?pagina=includes/product-information/product-sauna.php">Tipo 3</a></li>
...
O banho  turco também desintoxica o corpo, livrando o sangue, 
a pele e o cérebro  das gorduras e toxinas. Os. médicos indicam o banho  de sauna à vapor  nos casos de alergia  de pele, 
problemas nas vias  pulmonares, reumatismo, esgotamento físico  e mental, entre Outros.</figcaption>
            </figure>
        </div>
